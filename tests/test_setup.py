...
async def test_clear_storage(hacs):
    os.makedirs(f"{hacs.core.config_path}/.storage")
    with open(f"{hacs.core.config_path}/.storage/hacs", "w") as h_f:
        h_f.write("")
    assert os.path.exists(f"{hacs.core.config_path}/.storage/hacs")

    await async_clear_storage()
    assert not os.path.exists(f"{hacs.core.config_path}/.storage/hacs")

    os.makedirs(f"{hacs.core.config_path}/.storage/hacs")
    assert os.path.exists(f"{hacs.core.config_path}/.storage/hacs")
